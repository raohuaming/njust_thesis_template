...
\usepackage{dsfont}        % add by Tina 数学字体
%\usepackage{algorithm}     % add by Tina 写算法
%\usepackage{algorithmic}   % add by Tina 写算法
\usepackage{amssymb}
...
%\usepackage[hang]{caption}  % 标题的其它属性的自由控制 --- added by Tina
